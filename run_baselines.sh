...
python3 RunChargeWorld.py --agent ASAP  --save-name val_ASAP   --file-sessions df_synth_sessions_2019.csv --file-price df_prices_2019_c.csv &
python3 RunChargeWorld.py --agent NoV2G --save-name val_NoV2G  --file-sessions df_synth_sessions_2019.csv --file-price df_prices_2019_c.csv &
python3 RunChargeWorld.py --agent Optim --save-name val_Optim  --file-sessions df_synth_sessions_2019.csv --file-price df_prices_2019_c.csv &
python3 RunChargeWorld.py --agent ASAP  --save-name train_ASAP   --file-sessions df_synth_sessions_2014_2018.csv --file-price df_prices_c.csv &
python3 RunChargeWorld.py --agent NoV2G --save-name train_NoV2G  --file-sessions df_synth_sessions_2014_2018.csv --file-price df_prices_c.csv &
python3 RunChargeWorld.py --agent Optim --save-name train_Optim  --file-sessions df_synth_sessions_2014_2018.csv --file-price df_prices_c.csv &
