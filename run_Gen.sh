...
nohup python3 RunSACChargeWorld.py --agent SAC-sagg --save-name month_sac_gen_G_k --years 300 --batch-size 512 --learning-starts 0 --alpha 0.02 -ta = 0.001 --rng-test True --policy-frequency 4 --target-network-frequency 2 --general True &
