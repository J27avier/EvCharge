...
python3 RunSACChargeWorld.py --agent SAC-sagg --save-name 6month_sac_gen_g --years 300 --batch-size 512 --learning-starts 0 --alpha 0.02 --rng-test True --policy-frequency 4 --target-network-frequency 2 --general True --disagg P  &
...
python3 RunSACChargeWorld.py --agent SAC-sagg --save-name 6month_sac_gen_i --years 300 --batch-size 512 --learning-starts 0 --alpha 0.02 --rng-test True --policy-frequency 4 --target-network-frequency 2 --general True --disagg LL &
